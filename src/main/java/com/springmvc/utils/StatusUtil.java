...
public class StatusUtil {
    ...
    public static void main(String[] args) {
        ...
        ClientStatus a = getClientStatus("测试工程",1,"1", "123", "1,1", null);
        System.out.println(a.getTotalMemory());
        System.out.println(a.getFreeMemory());
        System.out.println(a.getMaxMemory());
    }
    public ClientStatus getClientStatus(){
        return getClientStatus("测试工程",1,"1", "123", "1,1", null);
    }
    /**
     *
